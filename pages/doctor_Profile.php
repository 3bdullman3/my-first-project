				...
				<div class="profile-tab-nav border-right">
					<div class="p-4">
						<div class="img-circle text-center mb-3">
							<img src="../images/avatar_doctor.png" alt="Image" class="shadow">
						</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="doctor_Fname" value="<?php echo  $_SESSION['doctor_Fname'];?>" <?php echo"$read" ; ?>>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
								  	<label>اللقب </label>
								  	<input type="text" name="doctor_Lname" class="form-control" value="<?php echo  $_SESSION['doctor_Lname'];?>" <?php echo"$read" ; ?>>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
								  	<label>الرقم الوظيفي</label>
								  	<input type="text" name="id_doctor" class="form-control" value="<?php echo  $_SESSION['id_doctor'];?>" readonly>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
								  	<label>رقم الجوال</label>
								  	<input type="text" name="doctor_phone" class="form-control" value="<?php echo  $_SESSION['doctor_phone'];?>" <?php echo"$read" ; ?>>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
								  	<label>تخصص</label>
								  	<input type="text" name="doctor_specialty" class="form-control" value="<?php echo  $_SESSION['doctor_specialty'];?>" <?php echo"$read" ; ?>>
								</div>
							</div>
							<div class="col-md-6">
							<div class="form-group">
								  	<label>المسمى الوظيفي</label>
								  	<input type="text" class="form-control" value="<?php echo "طبيب";?>" readonly>
        ...
        <?php
             $conn = mysqli_connect("localhost","root", "","maoede");
                if (isset($_GET['ok'])){
                    $Fname_doctor = $_GET['doctor_Fname'];
                    $Lname_doctor = $_GET['doctor_Lname'];
					$doctor_phone = $_GET['doctor_phone'];
					$doctor_specialty = $_GET['doctor_specialty'];                    
                    $password = $_GET['password'];
                    $sql = "update doctor set Fname_doctor = '$Fname_doctor', Lname_doctor = '$Lname_doctor' ,
					 specialty = '$doctor_specialty', Phone_doctor = '$doctor_phone'   where id_doctor = '".$_SESSION['id_doctor']."';";
